...
<section id="container" class="">
    ...
    <section id="main-content">
        <section class="wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h3 class="page-header"><i class="fa fa fa-bars"></i> 通知公告</h3>
                    <ol class="breadcrumb">
                        <li><i class="fa fa-home"></i>
                            <a href="${APP_PATH}/user/shouye">首页</a>
                        </li>
                        <li><i class="fa fa-bars"></i>通知公告</li>
                    </ol>
                </div>
            </div>
            <div class="row">
                <table cellpadding="15">
                    ...
                    <c:forEach items="${tongzhi.records}" var="msg">
                        <tr>
                            <td>
                    ...
                    <!--显示分页信息-->
                    <c:if test="${tongzhi.pages>1 }">
                    <!--文字信息-->
                    <tr>
                        <td colspan="3">
                            当前${tongzhi.current}页,总${tongzhi.pages}页,总${tongzhi.total}条记录
                        </td>
                    </tr>
                    <!--分页条-->
                    <tr>
                        <td>
                            <ul class="pagination ">
                                <li><a href="${APP_PATH}/message/tongzhi/1">首页</a></li>
                                <c:if test="${tongzhi.hasPrevious() }">
                                    <li><a href="${APP_PATH }/message/tongzhi/${tongzhi.current-1}"> <span
                                            aria-hidden="true">&laquo;</span></a></li>
                                </c:if>
                                <c:forEach begin="1" end="${tongzhi.pages}" step="1" var="pageNum">
                                    <c:if test="${pageNum != tongzhi.current}">
                                        <li><a href="${APP_PATH }/message/tongzhi/${pageNum}">${pageNum }</a></li>
                                    </c:if>
                                    <c:if test="${pageNum == tongzhi.current}">
                                        <li class="active"><a
                                                href="${APP_PATH }/message/tongzhi/${pageNum}">${pageNum }</a></li>
                                    </c:if>
                                </c:forEach>
                                <c:if test="${tongzhi.hasNext() }">
                                    <li><a href="${APP_PATH }/message/tongzhi/${tongzhi.current+1 }"> <span
                                            aria-hidden="true">&raquo;</span></a></li>
                                </c:if>
                                <li><a href="${APP_PATH}/message/tongzhi/${tongzhi.pages}">末页</a></li>
                            </ul>
